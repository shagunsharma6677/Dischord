...
path.join(
  process.cwd(),
  'src/prisma/src/generated/client/libquery_engine-rhel-openssl-3.0.x.so.node'
);
...
path.join(
  process.cwd(),
  'src/prisma/src/generated/client/libquery_engine-debian-openssl-3.0.x.so.node'
);
// file annotations for bundling tools to include these files
