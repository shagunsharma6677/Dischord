...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/shagun-xcitech/Open Source/Dischord/apps/web/src/prisma/src/generated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "52e7eda198ccfd400e98977fafb20f227ce8974f48558a169ce4c2fea1b5b705",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/prisma/src/generated/client",
...
path.join(process.cwd(), "src/prisma/src/generated/client/libquery_engine-rhel-openssl-3.0.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/prisma/src/generated/client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
