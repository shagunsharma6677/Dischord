...
const config = {
  generator: {
    ...
    output: {
      value:
        '/home/shagunxcitech/Open Source/Dischord/apps/server/prisma/src/generated/client',
      fromEnvVar: null,
    },
    config: {
      engineType: 'library',
  ...
  inlineSchemaHash:
    '38ae813c4ca5fb8197b7dbc4b6466b0b5799060189a3287760254584e42bff91',
  copyEngine: true,
};
...
path.join(
  process.cwd(),
  'prisma/src/generated/client/libquery_engine-debian-openssl-3.0.x.so.node'
);
// file annotations for bundling tools to include these files
